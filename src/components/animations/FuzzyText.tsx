...
const FuzzyText: React.FC<FuzzyTextProps> = ({
    ...
    fontWeight = 900,
    fontFamily = 'inherit',
    color = '#8CFF00', // Matching the accent color from the screenshot (bright lime/yellow)
    enableHover = true,
    baseIntensity = 0.18,
    hoverIntensity = 0.5,
    fuzzRange = 15, // Reduced from 30 for less "spacing" effect
    fps = 60,
    ...
    glitchDuration = 200,
    gradient = null,
    letterSpacing = -2, // Negative letter spacing to make it less "spaced"
    className = ''
}) => {
    ...
    useEffect(() => {
        ...
        const init = async () => {
            ...
            const horizontalMargin = fuzzRange + 5; // Reduced from 20 for tighter layout
            const verticalMargin = direction === 'vertical' || direction === 'both' ? fuzzRange + 5 : 2;
